                            ...
                            <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                                <div className="hidden sm:ml-6 sm:block">
                                    <div className="flex space-x-4">
                                        <a href="/tasks" className="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Главная страница</a>
                                        ...
                                        <a href="/orgitems" className="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Оргструктура</a>
                                    </div>
                                </div>
                                ...
                                <div className="absolute right-0 z-0 mt-0 w-50 origin-top-right flex space-x-4">
                                    {user ? (
                                        <>
                                            <a className="rounded-md bg-gray-900 px-3 py-2 text-sm font-medium text-white hover:bg-gray-700" href="/userpage">
                                                <Avatar.Root size={'2xs'} key={user.email}>
                                                    <Avatar.Fallback name={user.fio} />
                                                    <Avatar.Image src={user.photo} />
                                                </Avatar.Root>
                                            </a>
                                            {/* Добавляем иконку уведомлений для авторизованного пользователя */}
                                            <NotificationIcon />
